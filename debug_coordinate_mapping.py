...
from nncf.torch.quantization.triton.reference import read_shape
from nncf.torch.quantization.triton.reference import read_stride
...
def test_coordinate_mapping():
    ...
    debug_coordinate_kernel[grid](input_tensor, input_meta, grad_low, grad_low_meta, debug_output, BLOCK_SIZE=256)
