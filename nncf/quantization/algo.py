...
class PatternBasedQuantizerSetupGenerator(QuantizerSetupGeneratorBase):
    ...
    def _get_input_quantization_points(self) -> List[SingleConfigQuantizationPoint]:
        ...
        for ip in input_ips:
            ...
            # TODO[nlyalyus]: no adjust padding information. suppose it's not connected with conv or merged with corresponding PQ
...
class QuantizationBuilder(PTCompressionAlgorithmBuilder):
    ...
    def _get_adjust_padding_args(self, quantization_point: SingleConfigQuantizationPoint,
        ...
        if quantization_point.is_adjust_padding_applicable:
            for module_scope in quantization_point.parent_nodes_scopes:
...
class ExperimentalQuantizationController(QuantizationController):
    ...
    def is_new_setup_requires_regeneration(self, quantizer_setup: SingleConfigQuantizerSetup) -> bool:
        ...
        for qp_id, qp in quantizer_setup.quantization_points.items():
            ...
            need_padding_regeneration = qp.is_adjust_padding_applicable and \
