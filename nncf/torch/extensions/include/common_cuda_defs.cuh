...
inline dim3 get_2d_grid_size_for_per_channel(const uint32_t scale_count, const uint32_t elements_per_scale)
{
    ...
    // uint32_t available_threads_per_scale = elements_per_scale;
    // uint32_t blocks_per_scale = 1;
    ...
    // std::cout << "grid_size_x: " << grid_size_x << " grid_size_y: " << grid_size_y << std::endl;
    // std::cout << "aligned: " << align(available_threads_per_scale, CUDA_WARP_SIZE) << std::endl;
    // std::cout << "available_warps_per_scale: " << available_warps_per_scale << std::endl;
    // std::cout << "available_threads_per_scale: " << available_threads_per_scale << std::endl;
