...
def compress_weights(model: torch.nn.Module, use_fake_quantize: bool = False, alpha=0) -> torch.nn.Module:
    """
    ...
    insert_pre_compression_operations(model, use_fake_quantize, alpha)
