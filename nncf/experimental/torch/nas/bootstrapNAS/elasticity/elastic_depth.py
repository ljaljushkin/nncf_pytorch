...
class ElasticDepthParams(BaseElasticityParams):
    ...
    def __init__(self,
        ...
        :param allow_overlapping_blocks: If true, automatic block search will consider overlapping blocks: the ones that
        are partly or fully intersected with other blocks. By default, overlapping blocks are declined during the
    ...
    def from_config(cls, config: Dict[str, Any]) -> 'ElasticDepthParams':
        ...
        kwargs = {
            ...
            cls._state_names.ALLOW_OVERLAPPING_BLOCKS: config.get(cls._state_names.ALLOW_OVERLAPPING_BLOCKS, False),
    ...
    def get_state(self) -> Dict[str, Any]:
        ...
        return {
            ...
            self._state_names.ALLOW_OVERLAPPING_BLOCKS: self.allow_overlapping_blocks,
    ...
    def __str__(self):
        return f"{self.__class__.__name__}: max_block_size: {self.max_block_size} " \
               f"min_block_size: {self.min_block_size} allow_overlapping_blocks: {self.allow_overlapping_blocks} " \
        ...
        if self._skipped_blocks is None:
            extended_blocks, self._skip_dependencies = \
                get_building_blocks(
                    ...
                    allow_overlapping_blocks=self._params.allow_overlapping_blocks,
