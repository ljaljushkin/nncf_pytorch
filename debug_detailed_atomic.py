...
for block_size in [32, 64, 128, 256]:
    ...
    def fixed_block_kernel(
        grad_output_ptr, grad_output_meta, input__ptr, input__meta,
        input_low_ptr, input_low_meta, input_range_ptr, input_range_meta,
        levels, level_low, level_high, grad_input_ptr, grad_low_ptr, grad_low_meta,
        grad_range_ptr, grad_range_meta
    ):
