...
TASK="WWB"
LOG_FILE=$NNCF_CKPT_DIR/"${MODEL_NAME}_${TASK}_chat.log"
OUTPUT_PATH=$NNCF_CKPT_DIR/"results_${TASK}_chat.json"
CUDA_VISIBLE_DEVICES=6 PYTHONIOENCODING=utf-8 python wwb_eval_chat.py -m=$BASE_MODEL -n=$NNCF_CKPT_DIR > $LOG_FILE 2>&1  &
pid=$!
echo "The process ID: $pid, log file: $LOG_FILE"
