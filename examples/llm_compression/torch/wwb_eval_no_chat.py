...
wwb_ref = model_dir / "wwb_torch_ref_no_chat.csv"
# wwb_eval = None
# if wwb_ref.exists():
#     print("Loading cached WWB reference answers from: ", wwb_ref.resolve())
wwb_eval = TextEvaluator(
    tokenizer=tokenizer, gt_data=wwb_ref, test_data=str(wwb_ref), language="en"
)
# else:
# wwb_eval = TextEvaluator(
...
results_file = nncf_ckpt_dir / "results_wwb_no_chat.json"
