...
CUDA_VISIBLE_DEVICES=7 python eval.py -m HuggingFaceTB/SmolLM-1.7B-Instruct -f out_HuggingFaceTB_SmolLM-1_7B-Instruct_alpha_gs64_asym > /dev/null 2>&1 &
echo "Started eval with PID $!"
# CUDA_VISIBLE_DEVICES=2 python eval.py -m meta-llama/Llama-3.2-1B-Instruct -f out_meta-llama_Llama-3_2-1B-Instruct_alpha_gs64_asym > /dev/null 2>&1 &
# echo "Started eval with PID $!"
...
# echo "Started eval with PID $!"
# CUDA_VISIBLE_DEVICES=0 python eval.py -m meta-llama/Meta-Llama-3-8B-Instruct -f out_meta-llama_Meta-Llama-3-8B-Instruct_alpha_gs64_asym > /dev/null 2>&1 &
# echo "Started eval with PID $!"
# CUDA_VISIBLE_DEVICES=1 python eval.py -m mistralai/Mistral-7B-v0.3 -f out_mistralai_Mistral-7B-v0_3_alpha_gs64_asym  > /dev/null 2>&1 &
# echo "Started eval with PID $!"
