...
# run_model_async 4 meta-llama/Llama-3.2-3B-Instruct 1e-4 repro_r256_alpha_log "--lora_alpha 1 --lora_rank 256 --microbatch_size=2 --eval_seqlen=4096 --batch_size 64 --epochs 32"
...
# run_model_async 3 Qwen/Qwen2.5-1.5B-Instruct 1e-4 repro_r32_alpha "--lora_alpha 1 --lora_rank 32 --eval_seqlen=4096 --microbatch_size=2 --batch_size 64 --epochs 32"
...
# run_model_async 7 Qwen/Qwen2.5-1.5B-Instruct 1e-4 repro_r128_alpha "--lora_alpha 1 --lora_rank 128 --eval_seqlen=4096 --microbatch_size=2 --batch_size 64 --epochs 32"
...
# run_model_async 2 microsoft/Phi-3.5-mini-instruct 1e-4 repro_r256_alpha_log "--lora_alpha 1 --lora_rank 256 --microbatch_size=2 --eval_seqlen=4096 --batch_size 64 --epochs 32"
