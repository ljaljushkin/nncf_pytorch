...
# CUDA_VISIBLE_DEVICES=1 lm_eval --model hf --tasks gpqa --apply_chat_template --batch_size 8 --model_args pretrained=microsoft/Phi-3.5-mini-instruct-GPTQ-Int4
# CUDA_VISIBLE_DEVICES=2 lm_eval --model hf --tasks gpqa --apply_chat_template --batch_size 16 --model_args pretrained=microsoft/Phi-3.5-mini-instruct
# CUDA_VISIBLE_DEVICES=3 lm_eval --model hf --tasks hellaswag --batch_size 16 --model_args pretrained=microsoft/Phi-3.5-mini-instruct
...
# CUDA_VISIBLE_DEVICES=0 python eval.py -m microsoft/Phi-3.5-mini-instruct -f Qwen_Qwen2_5-1_5B-Instruct_repro_r128_alpha # > /dev/null 2>&1 &
# echo "Started eval with PID=$!"
# CUDA_VISIBLE_DEVICES=1 python eval.py -m microsoft/Phi-3.5-mini-instruct -f Qwen_Qwen2_5-1_5B-Instruct_repro_r128_alpha_t2 > /dev/null 2>&1 &
# echo "Started eval with PID=$!"



# CUDA_VISIBLE_DEVICES=0 python eval.py -m meta-llama/Llama-3.2-3B-Instruct -f meta-llama_Llama-3_2-3B-Instruct_repro_r256 > /dev/null 2>&1 &
# echo "Started eval with PID=$!"
# CUDA_VISIBLE_DEVICES=1 python eval.py -m meta-llama/Llama-3.2-3B-Instruct -f meta-llama_Llama-3_2-3B-Instruct_repro_r256_alpha_t2 > /dev/null 2>&1 &
# echo "Started eval with PID=$!"
...
# CUDA_VISIBLE_DEVICES=4 python eval.py -m microsoft/Phi-3-mini-4k-instruct -f microsoft_Phi-3-mini-4k-instruct_repro_r128_alpha > /dev/null 2>&1 &
# echo "Started eval with PID=$!"
# CUDA_VISIBLE_DEVICES=5 python eval.py -m microsoft/Phi-3-mini-4k-instruct -f microsoft_Phi-3-mini-4k-instruct_repro_r128_alpha_t2 > /dev/null 2>&1 &
# echo "Started eval with PID=$!"
...
echo "Started eval with PID=$!"
CUDA_VISIBLE_DEVICES=1 python eval.py -m microsoft/Phi-3.5-mini-instruct -f out_microsoft_Phi-3_5-mini-instruct_repro_r256_alpha_t2 > /dev/null 2>&1 &
echo "Started eval with PID=$!"
CUDA_VISIBLE_DEVICES=2 python eval.py -m microsoft/Phi-3.5-mini-instruct -f out_microsoft_Phi-3_5-mini-instruct_repro_r256_t2 > /dev/null 2>&1 &
echo "Started eval with PID=$!"
CUDA_VISIBLE_DEVICES=3 python eval.py -m microsoft/Phi-3.5-mini-instruct -f out_microsoft_Phi-3_5-mini-instruct_repro_r256_alpha > /dev/null 2>&1 &
echo "Started eval with PID=$!"
CUDA_VISIBLE_DEVICES=4 python eval.py -m microsoft/Phi-3.5-mini-instruct -f out_microsoft_Phi-3_5-mini-instruct_repro_r32 > /dev/null 2>&1 &
echo "Started eval with PID=$!"
CUDA_VISIBLE_DEVICES=5 python eval.py -m microsoft/Phi-3.5-mini-instruct -f out_microsoft_Phi-3_5-mini-instruct_repro_r32_alpha_t2 > /dev/null 2>&1 &
echo "Started eval with PID=$!"
CUDA_VISIBLE_DEVICES=6 python eval.py -m microsoft/Phi-3.5-mini-instruct -f out_microsoft_Phi-3_5-mini-instruct_repro_r32_t2 > /dev/null 2>&1 &
echo "Started eval with PID=$!"
CUDA_VISIBLE_DEVICES=7 python eval.py -m microsoft/Phi-3.5-mini-instruct -f out_microsoft_Phi-3_5-mini-instruct_repro_r32_alpha > /dev/null 2>&1 &
echo "Started eval with PID=$!"
