CUDA_VISIBLE_DEVICES=0 GROUP_SIZE=64 BENCHMARK_MODE=CUDA python main.py --num_train_samples 124 --epochs 1 | tee logs/cuda_asym_gs64_backup_none_no_reshape_all_bf16_NO_LORA_fwd_no_opt.log 2>&1
...
# PYTHONPATH=`pwd` GROUP_SIZE=64  BENCHMARK_MODE=CUDA python tools/benchmark_quantize_layers.py benchmark_cuda_no_lora_360m_bwd_opt.csv
