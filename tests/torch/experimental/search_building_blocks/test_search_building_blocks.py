...
REF_BUILDING_BLOCKS_FOR_SSD_MOBILENET = [
    BuildingBlock('MobileNetSSD/MultiOutputSequential[basenet]/Sequential[3]/ReLU[2]/relu__0',
                  'MobileNetSSD/MultiOutputSequential[basenet]/Sequential[3]/ReLU[5]/relu__0'),
    BuildingBlock('MobileNetSSD/MultiOutputSequential[basenet]/Sequential[5]/ReLU[2]/relu__0',
                  'MobileNetSSD/MultiOutputSequential[basenet]/Sequential[5]/ReLU[5]/relu__0'),
    BuildingBlock('MobileNetSSD/MultiOutputSequential[basenet]/Sequential[7]/ReLU[2]/relu__0',
                  'MobileNetSSD/MultiOutputSequential[basenet]/Sequential[7]/ReLU[5]/relu__0'),
    ...
    BuildingBlock('MobileNetSSD/MultiOutputSequential[basenet]/Sequential[11]/ReLU[2]/relu__0',
                  'MobileNetSSD/MultiOutputSequential[basenet]/Sequential[11]/ReLU[5]/relu__0'),
    BuildingBlock('MobileNetSSD/MultiOutputSequential[basenet]/Sequential[13]/ReLU[2]/relu__0',
                  'MobileNetSSD/MultiOutputSequential[basenet]/Sequential[13]/ReLU[5]/relu__0')
]
...
class BuildingBlockParamsCase:
    def __init__(self,
                 ...
                 ref_skipped_blocks: List[BuildingBlock],
                 ref_group_dependent: Dict[int, list[int]],
                 min_block_size: int = 5,
                 max_block_size: int = 50,
                 name: Optional[str] = None):
        self.model_creator = model_creator
        self.input_sizes = input_sizes
        self.ref_skipped_blocks = ref_skipped_blocks
        self.ref_group_dependent = ref_group_dependent
...
LIST_BB_PARAMS_CASES = [
    BuildingBlockParamsCase(ResNet50, RESNET50_INPUT_SIZE, REF_BUILDING_BLOCKS_FOR_RESNET,
                            REF_GROUP_DEPENDENT_RESNET50),
    BuildingBlockParamsCase(MobileNetV2, RESNET50_INPUT_SIZE, REF_BUILDING_BLOCKS_FOR_MOBILENETV2,
                            REF_GROUP_DEPENDENT_MOBILENETV2),
    BuildingBlockParamsCase(Inception3, INCEPTION_INPUT_SIZE, REF_BIG_BUILDING_BLOCKS_FOR_INCEPTION_V3,
                            REF_BIG_GROUP_DEPENDENT_INCEPTIONV3,
                            min_block_size=23, name='Inception3_big_blocks'),
    BuildingBlockParamsCase(Inception3, INCEPTION_INPUT_SIZE, REF_SMALL_BUILDING_BLOCKS_FOR_INCEPTION_V3,
                            REF_SMALL_GROUP_DEPENDENT_INCEPTIONV3,
                            min_block_size=3, max_block_size=3, name='Inception3_small_blocks'),
    BuildingBlockParamsCase(squeezenet1_0, RESNET50_INPUT_SIZE, REF_BUILDING_BLOCKS_FOR_SQUEEZENET,
                            REF_GROUP_DEPENDENT_SQUEEZNET),
    BuildingBlockParamsCase(test_models.ResNeXt29_32x4d, [1, 3, 32, 32], REF_BUILDING_BLOCKS_FOR_ResNext,
                            REF_GROUP_DEPENDENT_RESNEXT),
    BuildingBlockParamsCase(test_models.PNASNetB, [1, 3, 32, 32], REF_BUILDING_BLOCKS_FOR_PNASNetB,
                            REF_GROUP_DEPENDENT_PNASNETB),
    BuildingBlockParamsCase(test_models.ssd_mobilenet, [2, 3, 300, 300],
                            REF_BUILDING_BLOCKS_FOR_SSD_MOBILENET,
                            REF_GROUP_DEPENDENT_SSD_MOBILENET, min_block_size=2, max_block_size=7),
...
def test_building_block(desc: BuildingBlockParamsCase):
    ...
    assert skipped_blocks == desc.ref_skipped_blocks
    assert group_dependent == desc.ref_group_dependent
...
@pytest.mark.parametrize('algo_params', (
        (
                ...
                SearchBBlockAlgoParamsCase(min_block_size=8,
                                           ...
                                           ref_blocks=[BuildingBlock("ResNet/MaxPool2d[maxpool]/max_pool2d_0",
                                                                     "ResNet/Sequential[layer1]/BasicBlock[1]/relu_1")]),
                SearchBBlockAlgoParamsCase(max_block_size=14,
