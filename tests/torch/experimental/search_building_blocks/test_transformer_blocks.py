...
def check_extended_blocks(name, actual_blocks: ExtendedBuildingBlocks):
    ...
    with ref_file_path.open('r') as f:
        ...
        assert ref_blocks == actual_blocks, 'Blocks are different, set NNCF_TEST_REGEN_DOT=1 to override references ' \
...
LIST_FILTER_BLOCK_DESCS = [
    ...
    FilterBlockTestDesc(
        ...
        start_ids=[10, 28, 46, 37, 65, 83, 74, 102, 120, 111, 139, 130, 158, 176, 167, 195, 186, 214, 232, 223, 251,
                   242, 270, 261, 289],
