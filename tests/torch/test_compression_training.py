...
class TestCompression:
    ...
    def test_compression_train(self, nas_desc: NASTrainingTestDescriptor, tmp_path, mocker):
    ...
    def test_compression_eval(self, nas_desc: NASTrainingTestDescriptor, tmp_path, mocker):
        validator = nas_desc.get_validator()
        args = validator.get_default_args(tmp_path)
