...
def llm_compression_qat_with_lora() -> float:
    ...
    perplexity_diff_torch, best_perplexity_diff = qat_with_lora_main(args)

    return {"perplexity_diff_torch": perplexity_diff_torch, "best_perplexity_diff": best_perplexity_diff}
