...
def main():
    ...
    run_analysis(
        ...
        # ref_file="benchmark_ref_tmp_clean.csv",
        # pattern=r"benchmark_cuda_tmp_clean.csv|benchmark_triton_tmp_clean.csv|benchmark_compile_tmp_clean.csv",
        # ref_file="benchmark_ref_no_lora_360m_wall.csv",
        # pattern=r"benchmark_cuda_no_lora_360m_wall.csv|benchmark_compile_no_lora_360m_wall.csv|benchmark_triton_no_lora_360m_wall.csv",
        # ref_file="benchmark_ref_no_lora_360m.csv",
        # pattern=r"benchmark_cuda_no_lora_360m_bwd_opt.csv|benchmark_compile_no_lora_360m.csv|benchmark_triton_no_lora_360m.csv",
        # ref_file="benchmark_triton_no_lora_360m.csv",
        ref_file="COMPILE.csv",
        pattern=r"CUDA.csv|TRITON.csv|CUDA_opt.csv|CUDA_opt_2.csv|CUDA_2.csv",
        # ref_file="benchmark_cuda_tmp_3.csv",
        # pattern=r"benchmark_cuda_tmp_4.csv",
        ...
        excel=True,
        plot=True,
        output_prefix="comprehensive_analysis_gs64_no_lora_360m",
    )
